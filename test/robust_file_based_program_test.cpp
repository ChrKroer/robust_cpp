...
class robust_file_based_program_test : public ::testing::Test {
public:
  virtual void SetUp() {
...
TEST_F(robust_file_based_program_test, dimension) {
...
TEST_F(robust_file_based_program_test, num_constraints) {
